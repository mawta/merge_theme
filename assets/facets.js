...
$(document).ready(function () {
  if (navigator.userAgent.includes("Firefox") && $(window).width()>768) {
    if ($("details.facets__disclosure-vertical.js-filter").length) {
